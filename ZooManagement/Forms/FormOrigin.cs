...
namespace ZooManagement.Forms
{
    public partial class FormOrigin : Form
    {
        ...
        private void btn_Insert_Click(object sender, EventArgs e)
        {
            ...
            string sql = "insert into Origin values (@NAME,@NOTE)";
        ...
        private void txt_Update_Click(object sender, EventArgs e)
        {
            ...
            string sql = "Update Origin set Birth_type_name=@Name,Note=@NOTE where ID=@ID";
            SqlCommand cmd2 = new SqlCommand(sql, conn);
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            int id = int.Parse(txt_Id.Text);
            string sql = "Delete from Origin where ID=@ID";
            SqlCommand cmd2 = new SqlCommand(sql, conn);
            cmd2.Parameters.AddWithValue("@ID", id);
            cmd2.ExecuteNonQuery();
            conn.Close();
